...
- **Disbanding costs a quarter (asked for afterwards).** A quarter of the troops leaving a stack are lost. The rest go home only as far as the troop cap has room: with room for 100, a stack of 400 sends 133.3 (100 arrive, 33.3 are lost) and keeps 266.7, so nothing is wasted beyond the quarter. At the cap it is refused, and the button asks once more. Bots lose nothing when they fold stacks back in.
...
- **Evidence.**
  - 120 unit tests (4 new for the seek, 4 for drawn paths, 1 for descriptions, 1 for disbanding) and 95 kit tests.
  ...
  - Browser script 72 of 72 on both maps: descriptions in all three places, D then a drag, and a right-drag. With the disband check, 73 of 73 on the test map: "71 troops went home and 23 were lost."
