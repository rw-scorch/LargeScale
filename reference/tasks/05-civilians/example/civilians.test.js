...
import { installCivilians, zonePlots, econTick, startBuilding, tryUpgrade, conscript, bestTypeFor } from "./civilians.js";
import { makeRng } from "../../../shared/rng.js";
import { TID } from "../../../shared/terrain.js";
import { disc } from "../../../shared/grid.js";
...
test("residential zoning grows huts and people when fed", () => {
  ...
  const huts = [...w.civ.buildings.values()].filter(b => b.type === "hut_grass" && b.state === "active");
