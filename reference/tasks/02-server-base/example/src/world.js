...
import { World as Sim } from "../../../03-nations-territory/example/territory.js";
import { makeTestMap } from "../../../../shared/testmap.js";
import { planCatchUp, runCatchUp } from "../../../12-offline-play/example/offline.js";
...
export class World extends DurableObject {
  ...
  step(dt) {
    ...
    if (events.length) this.broadcast({ t: "events", events: events.slice(-50) });
  }
